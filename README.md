...
Editor for color palettes used on VGA screens under MS-Dos in the 1990s.

Developed under [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal), this program creates PAL extension files in which it stores colors and their hues.
...
You'll find the program (8 bits) in the “release” folder. This is the September 19, 1993 version. You can only run it on an MS-Dos emulator, Windows 3.x or 95. There's no point in trying it on Windows beyond these versions.
